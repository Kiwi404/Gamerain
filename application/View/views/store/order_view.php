            ...
            <div id='content'>
                ...
                <div id='text-spacer'>
                    <a href='menu.php' ><div id='game-button' style='width:300px;float:right'>< terug naar menu</div></a>
                        <h1>Bestellingen bekijken</h1>
                        <center>
                        <table border="2">
              <tr>
                <th width="50" style='background:#000;color:#fff'>ID</th>
                <th width="300" style='background:#000;color:#fff'>Gebruiker</th>
                <th width="150" style='background:#000;color:#fff'>Korting</th>
                <th width="300" style='background:#000;color:#fff'>Games</th>
              </tr>
            </table>
                        <?php 
                            $c->loadOrderOverView();
